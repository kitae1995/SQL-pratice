...
각각 INNER , LEFT OUTER, RIGHT OUTER, FULL OUTER 조인 하세요. (달라지는 행의 개수 확인 /각자 주석으로/)
*/
SELECT
*
...
*/
SELECT
e.first_name,e.last_name,d.department_name AS 부서명
FROM employees e INNER JOIN departments d
ON e.department_id = d.department_id
...
*/
SELECT
e.employee_id,e.first_name || ' ' || e.last_name AS 이름 , e.salary, d.department_name, loc.city
FROM employees e INNER JOIN departments d
